                ...
                <div className="col-sm-5">
                    <form onSubmit={handleSubmitReview}>
                        ...
                        <div className="mb-3">
                            ...
                            <textarea className="form-control" id="textReview" onChange={handleTextChange} aria-describedby="textReviewHelp" placeholder="Please write any thoughts or feedback here..." style={{ height: '150px', width: '350px'}} required></textarea>
                        </div>
